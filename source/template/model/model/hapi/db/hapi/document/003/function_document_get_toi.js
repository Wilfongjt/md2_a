...
module.exports = class FunctionDocumentGetToi extends Step {
  constructor(baseName, baseVersion) {
    ...
    this.params = 'token TOKEN, owner OWNERID, id PRIMARYKEY';
    this.types = 'TOKEN, OWNERID, PRIMARYKEY';

    this.sql = `
    DROP FUNCTION if exists api_0_0_1.document(token,ownerid,triple);
    ...
    BEGIN
      -- [Function: get ${this.name} given user_token TOKEN, Owner OWNERID, id PRIMARYKEY]
      ...
      result := base_${this.baseVersion}.get(owner, primarykey);
