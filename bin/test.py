...
def main(status=None):
    ...
    #source.component.data.main(status)
    ...
    source.component.template_files.main(status)
    ...
    source.component.markdown.active.main(status)
    source.component.markdown.claims.main(status)
    source.component.markdown.copyable.main(status)
    ...
    source.component.markdown.project_md.main(status)
    source.component.markdown.project_string_default.main(status)
    source.component.markdown.resources.main(status)
    source.component.markdown.scalars.main(status)
    source.component.markdown.scopes.main(status)
    source.component.markdown.tier_md.main(status)
    source.component.markdown.version.main(status)
